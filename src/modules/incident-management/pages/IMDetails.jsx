...
export default function IMDetails() {
  ...
  const [huProject, setHuProject] = useState("M3 Infrastructure");
  ...
  React.useEffect(() => {
    if (rawIncident) {
      ...
      setHuProject(hu.projectName || inc.projectName || "M3 Infrastructure");
            ...
            <div className="mod-card mb-4">
              ...
              <div className="mod-card-body" style={{ padding: "24px" }}>
                ...
                <div className="grid-2" style={{ rowGap: "14px" }}>
                  <div className="mod-form-group"><label className="mod-form-label">Project Name</label><div className="readonly-box">{huProject || incident.projectName || "M3 Infrastructure"}</div></div>
